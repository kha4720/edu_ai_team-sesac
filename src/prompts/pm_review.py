...
Gate 3 에는 PM review 를 추가하지 않는다.
PM 이 구현 명세서 4종 중 3종(data_schema / state_machine / interface_spec) 의
직접 작성자이므로 자기 산출물 자가 검토는 의미 없음.
(같은 원칙으로 Gate 1 에선 Edu 를 제외했음 — worklog 15 참조)
"""
